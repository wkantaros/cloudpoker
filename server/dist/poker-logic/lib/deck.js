...
exports.rankKickers = rankKickers;
exports.rankHandInt = rankHandInt;
...
function fillDeck(deck) {
  ...
  deck.push('4C');
  deck.push('3C');
  deck.push('2C'); //Shuffle the deck array with Fisher-Yates
...
function rankHandInt(hand) {
  ...
  cards = hand.cards.toString(); //Four of a kind
